    ...
    def _record_wfo_monthly_result(self, result: dict) -> None:
        ...
        try:
            ...
            rec = {
                ...
                "sharpe_ann": float(result.get("sharpe_ann", float("nan"))),
                ...
                "sharpe_gap_pct": float(result.get("sharpe_gap_pct", float("nan"))),
                "return_gap_pct": float(result.get("return_gap_pct", float("nan"))),
                "cv_fold_sharpes": result.get("cv_fold_sharpes", []),
