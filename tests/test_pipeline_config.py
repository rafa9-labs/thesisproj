...
def test_dqn_load_default_missing_file():
    ...
    from pipeline.models.dqn_config import _load_default_dqn_cfg
...
def test_class_defaults_immutability():
    ...
    from pipeline.metrics.metrics_tuples import CLASS_DEFAULTS, DEFAULT_FEATURES, DEFAULT_CV
...
def test_hpo_persistence_roundtrip(tmp_path, monkeypatch):
    ...
    from pipeline.hpo.hpo_persistence import save_hpo_config_to_disk, load_hpo_config_from_disk
    import pipeline.hpo.hpo_persistence as hpo_mod
