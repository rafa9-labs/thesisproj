...
export const STUDY_PRESETS = {
  diagnostic: {
    ...
    targetCoverage: 0.1,
    description: "Quick pipeline check. 10 HPO trials, 1 run. Not statistically meaningful.",
  ...
  exploratory: {
    ...
    targetActiveRate: 0.15,
    targetCoverage: 0.15,
    description: "Detects seed-dependent strategies. 50 trials x 3 runs.",
  ...
  validation: {
    ...
    targetActiveRate: 0.15,
    targetCoverage: 0.15,
    description: "Median-of-5 robustness. 100 trials x 5 runs. Results above ~0.6 Sharpe are publishable.",
  ...
  production: {
    ...
    targetActiveRate: 0.15,
    targetCoverage: 0.15,
    description: "Maximum statistical rigor. 200 trials x 10 runs. Decile confidence bands.",
