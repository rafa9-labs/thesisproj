    ...
    options: [
      {
        ...
        subtitle: "Quick pipeline validation",
        models: ["logistic"],
        hpoIntensity: "light" as const,
        nTrials: 10,
        repeats: 1,
      ...
      },
      {
        key: "signal",
        label: "Quick Signal",
        subtitle: "Check if any signal exists",
        models: ["xgboost"],
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        key: "classical_deep",
        label: "Deep",
        subtitle: "All 5 classical models",
      ...
      },
      {
        key: "classical_prod",
        label: "Production",
        subtitle: "All 5 models × more trials",
        models: ["logistic", "svm", "decision_tree", "random_forest", "xgboost"],
        hpoIntensity: "deep" as const,
        nTrials: 30,
        repeats: 1,
