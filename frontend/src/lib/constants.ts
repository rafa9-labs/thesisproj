    ...
    options: [
      {
        ...
        subtitle: "Pipeline validation — minimum viable test",
        models: ["logistic"],
        hpoIntensity: "light" as const,
        nTrials: 10,
        repeats: 1,
      ...
      },
      {
        key: "signal",
        label: "Quick Signal",
        subtitle: "Quick signal detection — 20 trials",
        models: ["xgboost"],
    ...
    options: [
      {
        key: "classical_min",
        label: "Minimal",
        subtitle: "Logistic — 30 HPO trials",
        models: ["logistic"],
        hpoIntensity: "standard" as const,
        nTrials: 30,
        repeats: 1,
      ...
      },
      {
        key: "classical_std",
        label: "Standard",
        subtitle: "Logistic + SVM + XGBoost — 50 trials each",
      ...
      },
      {
        key: "classical_deep",
        label: "Deep",
        subtitle: "All 5 classical — 80 trials each",
      ...
      },
      {
        key: "classical_prod",
        label: "Production",
        subtitle: "All 5 × deep HPO — 120 trials each",
        models: ["logistic", "svm", "decision_tree", "random_forest", "xgboost"],
        hpoIntensity: "deep" as const,
        nTrials: 120,
        repeats: 1,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        key: "deep_std",
        label: "Standard",
        subtitle: "LSTM + CNN — 60 trials each",
        models: ["lstm", "cnn"],
        hpoIntensity: "standard" as const,
        nTrials: 60,
        repeats: 1,
      ...
      },
      {
        key: "deep_prod",
        label: "Production",
        subtitle: "CNN + LSTM + Transformer — 100 trials each",
    ...
    options: [
      {
        key: "ensemble_min",
        label: "Minimal",
        subtitle: "Adaptive Regime — 30 HPO trials",
      ...
      },
      {
        key: "ensemble_std",
        label: "Standard",
        subtitle: "Both ensembles — 50 trials each",
      ...
      },
      {
        key: "ensemble_prod",
        label: "Production",
        subtitle: "Both × deep HPO — 80 trials each",
        models: ["ensemble_adaptive_regime", "ensemble_cnn_lstm_xgboost"],
        hpoIntensity: "deep" as const,
        nTrials: 80,
        repeats: 1,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        key: "rl_prod",
        label: "Production",
        subtitle: "DQN — 50 deep HPO trials",
        models: ["dqn"],
        hpoIntensity: "deep" as const,
        nTrials: 50,
        repeats: 1,
