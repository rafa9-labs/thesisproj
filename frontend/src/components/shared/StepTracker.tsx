      ...
      {steps.map((step, i) => {
        ...
        const circleBg = isActive
          ...
          : isComplete
            ...
            : "transparent";
        const circleBorder =
          isActive || isComplete ? "var(--color-brand)" : "var(--color-text-dim)";
        ...
        return (
          <div key={step.key} className="flex flex-1 items-start" style={{ minWidth: 0 }}>
            ...
            >
              <span
                className="flex items-center justify-center rounded-full font-mono text-[12px] font-bold transition-all duration-150"
                style={{
                  width: 34,
                  height: 34,
              ...
              <span
                className="text-center text-[11px] font-semibold tracking-[0.02em]"
                style={{
                  color: isActive
                    ? "var(--color-brand)"
                    : isComplete
